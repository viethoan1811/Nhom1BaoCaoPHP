...
class Dangnhap extends CI_Controller {
    ...
    public function dangky(){
        ...
        if($this->form_validation->run() ==TRUE){
            ...
            // $config['smtp_user']    = 'n2ftechnology@gmail.com';
            // $config['smtp_pass']    = 'qtfghkoibenvzzot';
            ...
            // $this->email->from('n2ftechnology@gmail.com', 'Website cây cảnh');
            // $this->email->to($email);
            // $this->email->subject('Hệ thống Website cây cảnh - Quà thành viên mới');
            // $this->email->message('Bạn đã trở thành thành viên mới của cửa hàng bán cây cảnh, Cửa hàng tặng bạn 1 mã giảm giá giảm 100.000 đ : '.$tempcoupon.' , Mã này có giá trị tới ngày '.$tempdatelimit.'
        ...
        $this->data['title']='Website cây cảnh - Đăng ký tài khoản';   
